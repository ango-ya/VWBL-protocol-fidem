    ...
    ERC1155BurnableUpgradeable
{
     ...
     * @param receiptId The receipt ID (generated by server)
     ...
     * @param receiptIds Array of receipt IDs (generated by server)
    ...
    function mintBatch(
        ...
        require(receiptIds.length == batchSize, "ReceiptIds length mismatch");
    ...
    function _processMint(
        ...
        // Validate inputs
        require(receiptId > 0, "ReceiptId must be greater than 0");
        require(receipts[receiptId].receiptId == 0, "ReceiptId already exists");
